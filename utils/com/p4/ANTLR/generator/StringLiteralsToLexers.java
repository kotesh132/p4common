...
public class StringLiteralsToLexers extends ANTLRv4ParserBaseVisitor<String>{
	...
	;
	 */
	@Override public String visitLabeledLexerElement(@NotNull ANTLRv4Parser.LabeledLexerElementContext ctx) {
		temp.append(ctx.id().getText());
		if(ctx.ASSIGN() != null){
			temp.append(" = ");
		} else {
	...
	@Override public String visitLexerBlock(@NotNull ANTLRv4Parser.LexerBlockContext ctx) {
		temp.append("(");
	...
	;
	 */
	@Override public String visitLexerCommands(@NotNull ANTLRv4Parser.LexerCommandsContext ctx) {
		temp.append(" ->");
		String prefix = "";
		for(LexerCommandContext l : ctx.lexerCommand()){
			temp.append(prefix);
			prefix = ",";
