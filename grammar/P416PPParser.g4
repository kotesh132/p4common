...
ppChars locals [ PpCharsContextExt extendedContext ] :   ppCharsWithOutBegin | ppCharsWithBegin ;
ppCharsWithOutBegin locals [ PpCharsWithOutBeginContextExt extendedContext ] :    ( STRING | WS | DEFINED | ppId | PREPROCESS_ERROR | PREPROCESS_IF | PREPROCESS_ELSE | PREPROCESS_ENDIF | COMMA | PAREN_OPEN | PAREN_CLOSE | ppChar )+    ;
ppCharsWithBegin locals [ PpCharsWithBeginContextExt extendedContext ] :   PREPROCESS_BEGIN ( STRING | WS |DEFINED | ppId | PREPROCESS_ERROR | COMMA | PAREN_OPEN | PAREN_CLOSE | ppChar )+    ;
