...
public interface ANTLRv4ParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link ANTLRv4Parser#annotation}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAnnotation(ANTLRv4Parser.AnnotationContext ctx);
	/**
	 * Visit a parse tree produced by {@link ANTLRv4Parser#annotationArgs}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAnnotationArgs(ANTLRv4Parser.AnnotationArgsContext ctx);
	/**
	 * Visit a parse tree produced by {@link ANTLRv4Parser#annotationArg}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAnnotationArg(ANTLRv4Parser.AnnotationArgContext ctx);
	/**
